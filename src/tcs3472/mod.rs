//! Copied from https://github.com/eldruin/tcs3472-rs and adapted to Embassy.
//!
...
mod configuration;
mod interface;
use interface::{BitFlags, Register, DEVICE_ADDRESS};
mod reading;
mod types;
pub use types::{AllChannelMeasurement, Error, RgbCGain, RgbCInterruptPersistence};
...
impl<I2C, E, EA> Tcs3472<I2C>
where
    I2C: I2cBlocking<Error = E> + I2cAsync<Error = EA>,
{
